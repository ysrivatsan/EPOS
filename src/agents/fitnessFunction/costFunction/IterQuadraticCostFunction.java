 ...
 * @author Peter
 */
public class IterQuadraticCostFunction extends IterativeCostFunction {

    private Random rand;

    public IterQuadraticCostFunction() {
        this(new Random());
    }

    public IterQuadraticCostFunction(long seed) {
        this(new Random(seed));
    }

    private IterQuadraticCostFunction(Random rand) {
        this.rand = rand;
    }
