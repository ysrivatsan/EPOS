 ...
 * @author Peter
 */
public class IterMinCostAdamGmS extends IterMinCost {
    ...
    */
    ...
    public IterMinCostAdamGmS(IterativeCostFunction costFunc, Factor factor) {
        super(costFunc);
        this.factor = factor;
    }
    ...
    public String toString() {
        return "IterMinCostAdamGmS " + factor;
    }
}
