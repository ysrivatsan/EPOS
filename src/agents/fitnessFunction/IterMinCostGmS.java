 ...
 * @author Peter
 */
public class IterMinCostGmS extends IterMinCost {
    ...
    public IterMinCostGmS(IterativeCostFunction costFunc, Factor factor, PlanCombinator combinator) {
        super(costFunc);
        this.factor = factor;
    ...
    public String toString() {
        return "IterMinCostGmS " + costFunc.toString() + " p+" + combinator + "(g)*" + factor;
    }
}
