 ...
 * @author Peter
 */
public class OrderedSparseDataset extends SparseDataset {

    public OrderedSparseDataset(int numPlans, int planSize, double std, int generationSteps) {
        super(numPlans, planSize, std, generationSteps);
    }
